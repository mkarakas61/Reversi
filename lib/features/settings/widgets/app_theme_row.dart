...
/// Two-option selector for the app-wide visual theme (Orijinal / Güzelsi). The
/// theme only sets the menu / colour shell — board and coin are chosen
/// independently (REV-70).
